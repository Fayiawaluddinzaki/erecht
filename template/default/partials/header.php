  ...
  <div class="row">
    <div class="col-lg-10">
      <a href="index.php" class="s-brand">
        <img class="s-logo animated flipInY delay7" style="width:120px;" src="<?php echo $sysconf['template']['dir']; ?>/default/img/newlogo.png" alt="<?php echo $sysconf['library_name']; ?>" />
        <h1 class="animated fadeInUp delay2"><?php echo $sysconf['library_name']; ?></h1>
        <!-- <h1 class="animated fadeInUp delay2"><?php echo "Erecht"; ?></h1> -->
        <!-- <div class="s-brand-tagline animated fadeInUp delay3"><?php echo "Pelindo Daya Sejahtera"; ?></div> -->
