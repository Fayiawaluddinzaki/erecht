  ...
  <script>
    $(document).ready(function () {
      $(function () {
        $('body').vegas({
          slides: [{
              src: "<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/img/bg/DSCF4571.jpg"
            },
            {
              src: "<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/img/bg/DSCF4695.jpg"
            },
            {
              src: "<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/img/bg/DSCF5647.jpg"
            },
            {
              src: "<?php echo $sysconf['template']['dir'].'/'.$sysconf['template']['theme']; ?>/img/bg/DSCF5896.jpg"
            }
          ],
