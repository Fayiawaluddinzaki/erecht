    ...
    <div class="row">
      <div class="col-lg-6 col-sm-3 col-xs-12">
        <div class="s-footer-tagline">
          <a href="https://ptpds.co.id" target="_blank"><h5>&copyPTPDS</h5></a>
        </div>
      </div>
      <nav class="col-lg-6 col-sm-9 col-xs-12">
        <ul class="s-footer-menu">
          ...
          <li><a target="_blank" rel="archives" href="https://www.youtube.com/c/pelindo3humas">Youtube</a></li>
          <li><a href="https://ptpds.co.id" class="fa fa-globe"> Website</a></li>
