          ...
          while ($book = $topbook->fetch_assoc()) :
            ...
            <li class="book">
              <a itemprop="name" property="name" href="./index.php?p=show_detail&amp;id=<?php echo $book['biblio_id'] ?>" title="<?php echo $book['title'] ?>">
                ...
                <img itemprop="image" src="./template/gogreen/img/book.png" alt="<?php echo $book['title'] ?>" />
              </a>
            </li>
            <?php
            endif;
    ...
    <div class="row">
      <div class="col-lg-6 col-sm-3 col-xs-12">
        <div class="s-footer-tagline">
          <a href="//slims.web.id" target="_blank">Inventaris APP</a>
        </div>
      </div>
      <nav class="col-lg-6 col-sm-9 col-xs-12">
        <ul class="s-footer-menu">
          ...
          <li><a target="_blank" rel="archives" href="https://www.youtube.com/c/pelindo3humas" class="fa fa-youtube-play"> Youtube</a></li>
          <li><a href="https://www.instagram.com/pelindodayasejahtera/?hl=id" class="fa fa-instagram"> Instagram</a></li>
          <!-- <li><a target="_blank" rel="archives" href="http://www.github.com/slims">Github</a></li> -->
          <li><a target="_blank" rel="archives" href="http://ptpds.co.id/" class="fa fa-globe"> Website</a></li>
