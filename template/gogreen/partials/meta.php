...
<?php else: ?>
<meta property="og:image" content="//<?php echo $_SERVER["SERVER_NAME"].SWB.$sysconf['template']['dir']; ?>/gogreen/img/logo.png"/>
<?php endif; ?>
...
<?php else: ?>
<meta property="twitter:image" content="//<?php echo $_SERVER["SERVER_NAME"].SWB.$sysconf['template']['dir']; ?>/gogreen/img/logo.png"/>
<?php endif; ?>
...
<!-- Script
============================================= -->
<script src="<?php echo $sysconf['template']['dir']; ?>/gogreen/js/jquery.min.js"></script>
...
<script src="<?php echo SWB; ?>template/gogreen/js/jquery.jcarousel.min.js"></script>
<script src="<?php echo $sysconf['template']['dir']; ?>/gogreen/js/jquery.transit.min.js"></script>
<script src="<?php echo $sysconf['template']['dir']; ?>/gogreen/js/bootstrap.min.js"></script>
<script src="<?php echo $sysconf['template']['dir']; ?>/gogreen/js/custom.js"></script>

<!-- Animation options
============================================= -->
<?php if($sysconf['template']['run_animation']) echo '<link rel="stylesheet" type="text/css" href="'.SWB.'template/gogreen/css/animate.min.css" />'; ?>

<!-- Style Minified
============================================= -->
<!-- <link rel="stylesheet" type="text/css" href="<?php echo SWB; ?>template/gogreen/style.min.css" /> -->
...
============================================= -->
<!-- For Developmet Only -->
<!-- <link rel="stylesheet/less" type="text/css" href="<?php echo SWB; ?>template/gogreen/style.less"/> -->
<!-- <script>less = { env: "development" };</script>
<script src="<?php echo $sysconf['template']['dir']; ?>/gogreen/js/less.min.js"></script> -->
