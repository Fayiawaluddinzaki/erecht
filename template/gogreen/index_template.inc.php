...
<?php   
			...
			if ($m == "AM") 
			{ if ($hour == 12) { echo "Good Evening "; } 
			elseif ($hour == 11) { echo "Good Afternoon "; }
			elseif ($hour == 10) { echo "Good Morning "; }
			elseif ($hour == 9) { echo "Good Morning " ; }
			elseif ($hour == 8) { echo "Good Morning "; }
			elseif ($hour == 7) { echo "Happy Sunshine "; }
			elseif ($hour == 6) { echo "Happy Sunshine "; }
			elseif ($hour == 5) { echo "Good Morning "; }
			elseif ($hour == 4) { echo "Good Morning "; }
			elseif ($hour == 3) { echo "Good Morning "; }
			elseif ($hour == 2) { echo "Good Morning "; }
			elseif ($hour == 1) { echo "Good Morning "; } }  
								
			elseif ($m == "PM") 
			{ if ($hour == 12) { echo "Good Afternoon "; } 
			elseif ($hour == 11) { echo "Good Night "; }
			elseif ($hour == 10) { echo "Good Night "; }
			elseif ($hour == 9) { echo "Good Night "; }
			elseif ($hour == 8) { echo "Good Night "; }
			elseif ($hour == 7) { echo "Good Night "; }
			elseif ($hour == 6) { echo "Happy Sunset "; }
			elseif ($hour == 5) { echo "Good Evening "; }
			elseif ($hour == 4) { echo "Good Evening "; }
			elseif ($hour == 3) { echo "Good Evening "; }
			elseif ($hour == 2) { echo "Good Afternoon "; } 
			elseif ($hour == 1) { echo "Good Afternoon "; } }   
?>
		<h1 class="jamdinding"><div class="jamdinding"><?php echo "". date("d-m-Y");?>&nbsp&nbsp<?php echo "". date("h:i"); ?></div>
			<!--
            ...
            <input type="text" class="s-search animated fadeInUp delay4" id="keyword" name="keywords" value="" lang="<?php echo $sysconf['default_lang']; ?>" aria-hidden="true" autocomplete="on">
            <button type="submit" name="search" value="search" class="s-btn animated fadeInUp delay4"><?php echo __('Search'); ?></button>
...
<script>
  ...
  $('.book img').error(function(){
    ...
    $(this).attr({
      src   : './template/gogreen/img/book.png',
  ...
  $('.librarian-image img').error(function(){
    $(this).attr('src','./template/gogreen/img/avatar.jpg');
  });
