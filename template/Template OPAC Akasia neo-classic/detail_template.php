...
<div class="slims-card slims-card--info">
	<div class="slims-row">
		<div class="slims-8">
		<div>
<a href="javascript: history.back();" title="Back" class="slims-button slims-button--red"><i class="material-icons">backspace</i></a></div>
		...
		<li id="inline" style="list-style-type: none;" ><?php echo $social_shares ?></li>
	</div>
</div>
