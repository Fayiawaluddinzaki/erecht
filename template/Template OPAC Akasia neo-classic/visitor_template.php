...
<div class="slims-container slims-visitor slims-vertical">
  <div class="slims-row">
	...
	<div class=" slims-card--default slims-card--expand">
		<div><b><marquee behavior="alternate" direction="down"><marquee behavior="alternate">
			<div  class="visitorcountertexthead"><a class="brand">Welcome To <?php echo $sysconf['library_name']; ?></a></div>
		</marquee></marquee></b></div>
	</div>

      <div class="slims-card slims-card--default slims-card--expand">
        <div class="slims-card--header neovisit" >
			<img  src='<?php echo $sysconf['template']['dir']; ?>/neo-classic/img/head_visitor.png'/>
			
      <div  class="visitorcountertext">
		<a class="brand"><?php echo __('Visitor Counter'); ?></a></div>
...
<div>
        <div class="slims-card--body">
          ...
          <form action="index.php?p=visitor" name="visitorCounterForm" id="visitorCounterForm" method="post">
			...
			<input type="reset" id="counter" name="counter" class="slims-button slims-button--white" value="<?php echo __('Cancel'); ?>">
          </form>
        </div>
