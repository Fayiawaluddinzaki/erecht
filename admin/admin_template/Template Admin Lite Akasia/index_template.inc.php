...
<tr>
    <td id="sidepan">
	    <div class="scroll"><?php echo $sub_menu; ?>
    </td>
    <td>
    	<a name="top"></a>
	    <div class="loader"><?php echo $info; ?>
		   <img src="<?php echo '../lib/minigalnano/createthumb.php?filename=../../'.IMG.'/persons/'.urlencode(urlencode($_SESSION['upict'])).'&width=15'?>" alt="Photo">
		</div>
		<div id="mainContent">
